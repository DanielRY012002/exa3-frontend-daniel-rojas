...
const routes: Routes = [
  ...
  {path: 'roles', component: ListarComponent, canActivate:[AuthrutasGuard, RoleGuard], data:{role:'GERENTE'}},
  {path: 'productos', component: ListarproComponent, canActivate:[AuthrutasGuard, RoleGuard], data:{role:'GERENTE'}}
];
